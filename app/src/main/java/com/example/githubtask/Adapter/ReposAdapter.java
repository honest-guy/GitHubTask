...
import com.example.githubtask.IssuesActivity;
import com.example.githubtask.Model.GitHubRepo;
import com.example.githubtask.R;
import com.example.githubtask.UserActivity;
...
public class ReposAdapter extends RecyclerView.Adapter<ReposAdapter.ReposViewHolder> {
    ...
    public static class ReposViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReposViewHolder(View v) {
            ...
            repoOpenIssues = (TextView) v.findViewById(R.id.repo_Open_Issues);
    ...
    public void onBindViewHolder(ReposViewHolder holder, final int position) {
        ...
        holder.repoOpenIssues.setText("Open Issues " + String.valueOf(repos.get(position).getOpen_issues_count()));
    }
